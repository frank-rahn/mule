 ...
 * 2014-04-18T21:07:37.336+02:00
 * Generated source version: 2.7.10
 * 
 */
@WebServiceClient(name = "EchoService", 
                  wsdlLocation = "http://xmlns.frank-rahn.de/ws/echo/1.0",
                  targetNamespace = "http://xmlns.frank-rahn.de/ws/echo/1.0") 
public class EchoService_Service extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://xmlns.frank-rahn.de/ws/echo/1.0", "EchoService");
    public final static QName EchoServiceSoap = new QName("http://xmlns.frank-rahn.de/ws/echo/1.0", "EchoServiceSoap");
    static {
        URL url = null;
        try {
            url = new URL("http://xmlns.frank-rahn.de/ws/echo/1.0");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(EchoService_Service.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://xmlns.frank-rahn.de/ws/echo/1.0");
        }
        WSDL_LOCATION = url;
    }
